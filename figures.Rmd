...
```{r plot-predictions, fig.width=5.5, fig.height=2.5}
...
plot_oda_predict <- ggplot(df_oda_predict, 
  ...
  labs(x = "Change from average number of anti-advocacy barriers",
       ...
       title = "Barriers to advocacy and aid") +
...
plot_contention_predict <- ggplot(df_contention_predict, 
  ...
  labs(x = "Change from average number of anti-advocacy barriers",
       ...
       title = "Barriers to advocacy and contentiousness of aid") +
  scale_y_continuous(labels = percent_format(accuracy = 1)) +
  theme_ngo() 

plot_predict_both <- 
  (plot_oda_predict + plot_contention_predict + plot_layout(ncol = 2)) &
  theme(plot.title = element_text(size = rel(0.9), family = "Oswald-Regular", face = "plain"),
