  ...
  ret <- theme_bw(base_size, base_family) +
    theme(plot.title = element_text(size = rel(1.4), face = "plain",
          ...
          strip.text = element_text(size = rel(1.1), hjust = 0,
                                    family = "Oswald-Regular", face = "plain"),
          strip.background = element_rect(fill = "#ffffff", colour = NA),
          axis.ticks = element_blank(),
          axis.title.x = element_text(margin = margin(t = 10)),
          axis.text = element_text(family = "Oswald Light", face = "plain"),
          legend.key = element_blank(),
          legend.text = element_text(size = rel(1), family = "Oswald ExtraLight", face = "plain"),
